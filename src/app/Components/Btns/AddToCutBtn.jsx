...
const AddToCutBtn = () => {
    ...
    return (
        <button
            ...
            className={`flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-xs font-semibold shadow-sm transition-all duration-200 active:scale-95 ${added ? "bg-rose-50 text-rose-600 border border-rose-200 shadow-rose-500/10 hover:bg-rose-100" : "bg-emerald-600 text-white shadow-emerald-500/20 hover:bg-emerald-500"}`}
        >
            {
                added ? <svg
                ...
                >
                    <path
                        ...
                        d="M5 13l4 4L19 7"
                    />
                </svg> : <svg className="h-4 w-4 fill-none stroke-current stroke-2" viewBox="0 0 24 24">
